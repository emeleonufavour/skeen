...
import 'package:myskin_flutterbytes/src/features/nav_bar/nav_bar.dart';

import '../../model/test_material_app.dart';

void main() {
  group("Navigation Bar View", () {
    testWidgets("NavBar UI components show correctly",
        (WidgetTester tester) async {
      await tester.pumpWidget(
          ProviderScope(child: TestMaterialAppWidget(route: NavBarView.route)));
